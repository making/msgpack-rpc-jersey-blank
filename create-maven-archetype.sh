...
sed -i -e "s/msgpack-rpc-jersey-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/msgpack-rpc-jersey-blank/g" pom.xml
...
sed -i -e "s/projectName/msgpack-rpc-jersey-blank/g" pom.xml
